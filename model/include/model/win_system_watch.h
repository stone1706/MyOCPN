...
/** \file win_system_watch.h Windows specific hardware events interface */
 ...
 * accordingly
 */
class WinSystemWatchDaemon : public UsbWatchDaemon {
public:
  WinSystemWatchDaemon(SystemEvents& se) : UsbWatchDaemon(se), done(false) {}
  ~WinSystemWatchDaemon();
